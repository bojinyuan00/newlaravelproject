		...
		<tbody>
			<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr class="text-c">
					...
					<td><?php echo e($val->auth_ids); ?></td>
					<td><?php echo e($val->auth_ac); ?></td>
					<td class="f-14">
						...
						<a title="分派权限" href="javascript:;" onclick="admin_role_assign('分派权限','/admin/role/assign','<?php echo e($val->id); ?>')" style="text-decoration:none"><i class="Hui-iconfont">&#xe61d;</i></a>  
