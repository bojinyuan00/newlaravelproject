...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 管理员管理 <span class="c-gray en">&gt;</span> 试题管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		<form class="Huiform" method="post" action="" target="_self">
			<input type="text" class="input-text" style="width:250px" placeholder="试题名称" id="" name="">
			<button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜试题节点</button>
		</form>
	</div>
	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="8">试题节点</th>
			</tr>
			<tr class="text-c">
				<th width="25"><input type="checkbox" name="" value=""></th>
				<th width="40">ID</th>
				<th width="150">题干</th>
				<th width="100">关联试卷</th>
				<th width="50">分值</th>
				<th width="150">选项</th>
				<th width="150">答案</th>
		...
		<tbody>
			@foreach($data as $val)
				<tr class="text-c">
					...
					<td>
						<a href="javascript:;" onclick="play_options('{{$val->options}}')" class="btn btn-primary radius">
							<i class="Hui-iconfont">&#xe6e6;</i>查看选项
						</a>
					</td>
					<td>
						{{$val->answer}}
